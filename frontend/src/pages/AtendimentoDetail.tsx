...
import type { AtendimentoItem } from '@/types';
...
export default function AtendimentoDetail() {
    ...
    return (
        ...
        <Card>
            ...
            {atendimento.treatment_duration_days !== null &&
                atendimento.treatment_duration_days !== undefined && (
                <p>
            ...
            <div className="flex gap-4 pt-3">
                ...
                <input
                    type="checkbox"
                    checked={atendimento.has_directives}
                    disabled
                    className="rounded"
                />
                ...
                <input
                    type="checkbox"
                    checked={atendimento.has_ancestralidade}
                    disabled
                    className="rounded"
                />
